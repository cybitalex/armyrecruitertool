...
export default function IntakeForm() {
  ...
  const form = useForm<InsertRecruit>({
    resolver: zodResolver(insertRecruitSchema.extend({
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Your recruitment application has been successfully submitted.",
      });
      navigate("/");
    },
    onError: (error: Error) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">U.S. Army Recruitment Application</h1>
            ...
            {currentStep === 1 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Please provide your legal name and date of birth</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Date of Birth * (Must be 17-42 years old)</FormLabel>
                        <FormControl>
            ...
            {currentStep === 3 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Tell us about your education and service history</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <FormField
                    control={form.control}
            ...
            {currentStep === 4 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Physical fitness and health information</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <FormField
            ...
            {currentStep === 5 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Let us know your preferences and when you can start</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <FormField
                    control={form.control}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>When are you available to start? *</FormLabel>
                        <Select onValueChange={field.onChange} value={field.value}>
                          <FormControl>
